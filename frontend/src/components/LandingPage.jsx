...
function LandingPage({ onGetStarted }) {
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-16">
                        ...
                        <div className="hidden md:flex items-center space-x-4">
                            ...
                            <a href="#pricing" className="text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition">
                                Pricing
                            </a>
                            <button
                            ...
                            <button
                                ...
                                className="bg-indigo-600 text-white px-6 py-2 rounded-lg hover:bg-indigo-700 transition duration-200 shadow-md shadow-indigo-600/30"
                            >
                                Get Started
                            </button>
                        </div>
            ...
            {/* Hero Section */}
            <section className="pt-12 pb-16 md:pt-20 md:pb-24 bg-linear-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-slate-900 dark:to-gray-950">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="text-center md:text-left">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                                ...
                                <button
                                    onClick={() => onGetStarted(true)}
                                    className="bg-white dark:bg-transparent dark:border dark:border-indigo-400 dark:text-indigo-300 text-indigo-600 border-2 border-indigo-600 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-indigo-50 dark:hover:bg-indigo-950/40 transition duration-200"
                                >
                                    Sign In
                                </button>
                            </div>
                            ...
                            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl p-8 transform hover:scale-105 transition duration-300 border border-transparent dark:border-gray-800">
                                <div className="space-y-4">
                                    <div className="flex items-center justify-between p-4 bg-green-50 dark:bg-green-900/40 rounded-lg">
                                        ...
                                        <span className="text-2xl font-bold text-green-600 dark:text-green-300">$5,420</span>
                                    </div>
                                    <div className="flex items-center justify-between p-4 bg-red-50 dark:bg-red-900/40 rounded-lg">
                                        <span className="text-gray-700 dark:text-gray-200 font-medium">Expenses</span>
                                        <span className="text-2xl font-bold text-red-600 dark:text-red-300">$3,280</span>
                                    </div>
                                    <div className="flex items-center justify-between p-4 bg-indigo-50 dark:bg-indigo-900/40 rounded-lg">
                                        <span className="text-gray-700 dark:text-gray-200 font-medium">Balance</span>
                                        <span className="text-2xl font-bold text-indigo-600 dark:text-indigo-300">$2,140</span>
                                    </div>
                                    <div className="pt-4">
            ...
            <section id="features" className="py-16 md:py-24 bg-white dark:bg-gray-950">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {/* Feature 1 */}
                        <div className="bg-linear-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/40 rounded-xl p-8 hover:shadow-xl transition duration-300 border border-transparent dark:border-blue-900/40">
                            <div className="bg-indigo-600/90 dark:bg-indigo-500/60 w-14 h-14 rounded-lg flex items-center justify-center mb-6">
                        ...
                        {/* Feature 2 */}
                        <div className="bg-linear-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/40 rounded-xl p-8 hover:shadow-xl transition duration-300 border border-transparent dark:border-purple-900/40">
                            <div className="bg-purple-600/90 dark:bg-purple-500/60 w-14 h-14 rounded-lg flex items-center justify-center mb-6">
                                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
                                </svg>
                            </div>
                            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Smart Categories</h3>
                            <p className="text-gray-600 dark:text-gray-300">
                        ...
                        {/* Feature 3 */}
                        <div className="bg-linear-to-br from-green-50 to-emerald-50 dark:from-emerald-900/20 dark:to-teal-900/40 rounded-xl p-8 hover:shadow-xl transition duration-300 border border-transparent dark:border-emerald-900/40">
                            <div className="bg-green-600/90 dark:bg-emerald-500/60 w-14 h-14 rounded-lg flex items-center justify-center mb-6">
                                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                            </div>
                            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Budget Goals</h3>
                            <p className="text-gray-600 dark:text-gray-300">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 md:gap-12">
                        <div className="text-center">
                            <div className="bg-indigo-600 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 text-white text-2xl font-bold shadow-lg shadow-indigo-600/40">
                                1
                            </div>
                        ...
                        <div className="text-center">
                            <div className="bg-purple-600 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 text-white text-2xl font-bold shadow-lg shadow-purple-600/40">
                                2
                            </div>
                            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Track Expenses</h3>
                            <p className="text-gray-600 dark:text-gray-300">
                        ...
                        <div className="text-center">
                            <div className="bg-pink-600 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 text-white text-2xl font-bold shadow-lg shadow-pink-600/40">
                                3
                            </div>
